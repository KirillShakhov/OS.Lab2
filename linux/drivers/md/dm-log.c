...
struct dm_dirty_log_type *myget_log_type(const char *type_name)
{
    char *p, *type_name_dup;
    struct dm_dirty_log_type *log_type;
...
struct dm_dirty_log_type my_get_disk_type(void) {
    return _disk_type;
}
EXPORT_SYMBOL(my_get_disk_type);

struct dm_dirty_log_type my_get_core_type(void) {
    return _core_type;
}
EXPORT_SYMBOL(my_get_core_type);
